        ...
        <>
            ...
            <div class='content-container-padding black-background-highlights'>
                <div class='highlight-desc-container white-background'>
                    <p id='hightlight-desc-p'>As well as the panels below that show the more impressive features of this project, there is a lot more code under the hood that handles complex logic that I invite you to look at.</p>
                    <svg id='hightlight-desc-svg' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
