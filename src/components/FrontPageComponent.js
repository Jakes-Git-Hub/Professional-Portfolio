...
{/* Contact me */} 
            ...
            <div class="content-container-padding-fp" id='squiggle-divide-project'>
                <div class='contact-title-margin slide-in-right-placeholder projects-h2-container' id='projects-nav'>
                    <h2 class='opposite-section-title'>
                    ...
                    <div class="contact-outer-margin-top relative py-3 sm:max-w-xl sm:mx-auto">
                        ...
                        <div class="inside-bg text-white relative px-4 py-10 shadow-lg sm:rounded-3xl sm:p-20">
                                ...
                                <div class="contact-buttons-container">
                                    <div>
                                        <button class="btn-5">
                                            ...
                                            <p>
                                                <span class='custom-span' style={{ '--i': 0 }}>S</span>
                                                <span class='custom-span' style={{ '--i': 1 }}>e</span>
                                                <span class='custom-span' style={{ '--i': 2 }}>n</span>
                                                <span class='custom-span' style={{ '--i': 3 }}>d</span>
                                            </p>
                                            </div>
